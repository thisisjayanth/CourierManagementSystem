...
submitupdate.addEventListener('click', () => {
    ...
    validateInputs(); 
     ...
     fetch('http://127.0.0.1:8000/api/user/updateProfile',{
         'method':'POST',
         'headers':{
      ...
      .then(data=>{
         ...
         document.getElementById('username2').innerHTML=data.user_name;
         username.value=data.user_name;
         email.value=data.user_email;
         address.value=data.user_address;
         pin.value=data.user_pincode;
         phonenumber1.value=data.user_phone_number;
         document.querySelector("#state").value=data.user_state;
         }
